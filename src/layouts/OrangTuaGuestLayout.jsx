...
export default function OrangTuaGuestLayout() {
    return (
        <div className='bg-base-200 min-h-screen w-screen max-w-md mx-auto flex flex-col shadow-2xl relative border-x border-base-300/60 overflow-hidden font-sans'>
            ...
            <div className="absolute top-[-10%] left-[-20%] w-[300px] h-[300px] rounded-full bg-secondary/10 blur-[80px] pointer-events-none" />
            <div className="absolute bottom-[10%] right-[-20%] w-[250px] h-[250px] rounded-full bg-accent/10 blur-[70px] pointer-events-none" />
            ...
            <header className='relative z-20 py-6 px-8 flex flex-col items-center gap-3 flex-shrink-0'>
                ...
                <div className="text-center mt-2">
                    ...
                    <p className="text-[10px] font-black text-secondary tracking-[0.15em] uppercase mt-0.5 opacity-90">
