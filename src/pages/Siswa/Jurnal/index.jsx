...
const KAIH_ITEMS = [
  {
    ...
    options: [
      { value: 4, label: "Bangun pukul \u2264 04.30, melaksanakan Shalat Subuh tepat waktu, dan mengaji Al-Qur'an." },
      { value: 3, label: "Bangun pukul 04.31\u201305.00, melaksanakan Shalat Subuh tepat waktu, namun belum mengaji Al-Qur'an." },
      { value: 2, label: "Bangun pukul 05.01\u201305.30, melaksanakan Shalat Subuh di akhir waktu, dan tidak mengaji Al-Qur'an." },
      { value: 1, label: "Bangun pukul 05.31\u201306.00, melaksanakan Shalat Subuh terlambat, dan tidak mengaji Al-Qur'an." },
      { value: 0, label: "Bangun setelah pukul 06.00, tidak melaksanakan Shalat Subuh, dan tidak mengaji Al-Qur'an." },
    ],
  },
  {
    id: "beribadah",
  ...
  },
  {
    ...
    options: [
      { value: 4, label: "Berolahraga lebih dari 30 menit setiap hari, seperti senam pagi, jalan kaki, berlari, bersepeda, bermain bola, atau olahraga lainnya." },
      { value: 3, label: "Berolahraga setiap hari, tetapi waktunya kurang dari 30 menit dan jenis olahraga yang dilakukan masih terbatas." },
      { value: 2, label: "Berolahraga ringan, seperti jalan kaki atau senam pagi, namun belum dilakukan setiap hari." },
      { value: 1, label: "Berolahraga hanya saat pelajaran olahraga di sekolah." },
      { value: 0, label: "Tidak melakukan olahraga dan aktivitas fisik." },
    ],
  },
  {
    id: "makan_sehat",
    ...
    ui: { bg: "bg-secondary/10", border: "border-secondary/30", text: "text-secondary" },
    options: [
      { value: 4, label: "Mengonsumsi makanan sehat dan bergizi lengkap yang terdiri atas karbohidrat, protein, sayur, buah, dan air putih yang cukup." },
      { value: 3, label: "Mengonsumsi makanan sehat dan bergizi, namun masih jarang mengonsumsi sayur, buah, atau air putih yang cukup." },
      { value: 2, label: "Mengonsumsi makanan sehat, tetapi masih sering memilih jajanan, makanan manis, atau makanan instan." },
      { value: 1, label: "Lebih sering mengonsumsi jajanan atau makanan ringan dibandingkan makanan bergizi." },
      { value: 0, label: "Tidak terbiasa mengonsumsi makanan sehat dan lebih sering mengonsumsi makanan cepat saji, minuman manis, atau makanan instan setiap hari." },
    ],
  },
  {
    id: "gemar_belajar",
    ...
    options: [
      { value: 4, label: "Membaca buku pelajaran atau buku cerita, mengerjakan tugas sekolah, serta berlatih mengerjakan soal dan menulis rangkuman pelajaran secara mandiri." },
      { value: 3, label: "Membaca buku pelajaran atau buku cerita dan mengerjakan tugas sekolah, namun jarang berlatih soal atau menulis rangkuman pelajaran." },
      { value: 2, label: "Membaca buku pelajaran atau buku cerita dan mengerjakan tugas sekolah, tetapi belum terbiasa berlatih soal atau menulis rangkuman pelajaran." },
      { value: 1, label: "Mengerjakan tugas sekolah setelah diingatkan dan jarang membaca buku di rumah." },
      { value: 0, label: "Tidak membaca buku dan tidak mengerjakan tugas sekolah di rumah." },
    ],
  },
  {
    id: "bermasyarakat",
    ...
    ui: { bg: "bg-accent/10", border: "border-accent/30", text: "text-accent" },
    options: [
      { value: 4, label: "Membantu orang tua di rumah, bermain baik dengan teman atau tetangga di lingkungan rumah, membantu piket kelas, membersihkan lingkungan sekitar, dan ikut kerja bakti." },
      { value: 3, label: "Membantu orang tua di rumah, bermain baik dengan teman atau tetangga, membantu piket kelas, dan membersihkan lingkungan sekitar, tetapi belum ikut kerja bakti." },
      { value: 2, label: "Membantu orang tua di rumah, bermain dengan teman atau tetangga, dan membantu piket kelas, namun belum ikut membersihkan lingkungan atau kerja bakti." },
      { value: 1, label: "Membantu orang tua setelah diminta dan jarang bermain atau ikut kegiatan bersama teman atau tetangga di lingkungan rumah." },
      { value: 0, label: "Tidak membantu orang tua, tidak membantu piket kelas, dan tidak ikut menjaga kebersihan lingkungan sekitar." },
    ],
  },
  {
    id: "tidur_cepat",
    ...
    fullWidth: true,
    options: [
      { value: 4, label: "Tidur pukul \u2264 20.30, sudah menyiapkan perlengkapan sekolah, dan tidak bermain gawai sebelum tidur." },
      { value: 3, label: "Tidur pukul 20.31\u201321.00, sudah menyiapkan perlengkapan sekolah, tetapi masih bermain gawai sebelum tidur." },
      { value: 2, label: "Tidur pukul 21.01\u201321.30, perlengkapan sekolah belum disiapkan lengkap, dan masih bermain gawai sebelum tidur." },
      { value: 1, label: "Tidur pukul 21.31\u201322.00, belum menyiapkan perlengkapan sekolah, dan masih bermain gawai sebelum tidur." },
      { value: 0, label: "Tidur pukul > 22.00 karena masih bermain atau menggunakan gawai hingga larut malam." },
    ],
  },
]

const BERIBADAH_MUSLIM_OPTIONS = [
  { value: 4, label: "Melaksanakan seluruh shalat wajib (Subuh, Dzuhur, Ashar, Magrib, Isya) dan melaksanakan shalat sunnah." },
  { value: 3, label: "Melaksanakan 4 dari 5 shalat wajib, namun belum melaksanakan shalat sunnah." },
  { value: 2, label: "Melaksanakan 3 dari 5 shalat wajib dan belum melaksanakan shalat sunnah." },
  { value: 1, label: "Melaksanakan 1\u20132 dari 5 shalat wajib dan belum melaksanakan shalat sunnah." },
  { value: 0, label: "Tidak melaksanakan shalat wajib maupun shalat sunnah." },
]

const BERIBADAH_NON_MUSLIM_OPTIONS = [
  { value: 4, label: "Melaksanakan doa/ibadah harian secara rutin dan membaca kitab suci." },
  { value: 3, label: "Melaksanakan doa/ibadah harian secara rutin, namun jarang membaca kitab suci." },
  { value: 2, label: "Melaksanakan doa/ibadah harian sesekali dan belum terbiasa membaca kitab suci." },
  { value: 1, label: "Melaksanakan doa/ibadah hanya jika diingatkan oleh orang tua atau guru." },
  { value: 0, label: "Tidak melaksanakan doa/ibadah harian maupun membaca kitab suci." },
]
